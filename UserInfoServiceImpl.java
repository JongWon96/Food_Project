...
public class UserInfoServiceImpl implements UserInfoService {
	...
	@Override
	public UserInfo getUidByUnameAndUphone(String uname, int uphone) {
		return userinfoRepo.findByUnameAndUphone(uname, uphone);
	}

	@Override
	public UserInfo getUpwByUidUnameUphone(String uid, String uname, int uphone) {
	...
	public List<UserInfo> getUserInfoList(String uname) {
		return userinfoRepo.findUserInfoByUnameContaining(uname);
	}
